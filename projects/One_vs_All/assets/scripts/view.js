...
function View() {
    ...
    this.updateState = function(content, links, width, height) {
        ...
        if (
            content === links.game ||
            content === links.level1 ||
            content === links.level2 ||
            content === links.level3 ||
            content === links.level4 ||
            content === links.level5 ||
            content === links.level6
        ) {
    ...
    this.showLevelStartButton = function() {
        myViewContainer.querySelector('#start-lvl').style.display = 'block';
    };
    ...
    this.hideLevelStartButton = function() {
        myViewContainer.querySelector('#start-lvl').style.display = 'none';
    };
